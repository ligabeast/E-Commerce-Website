    ...
    <form action="/sell/set_article/list" method="post" class="p-10 flex flex-col wrap space-y-5 border-t-2 border-black my-5">
        ...
        <div class="flex justify-between ">
            <div class="flex items-center space-x-5">
                ...
                <input required name="price" type="number" step=".01" class="bg-gray-200 border border-black text-lg rounded-xl px-5 py-3 w-32 outline-0">
            </div>
            <button type="submit" class="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-blue-600 border-2 border-blue-600 rounded-full hover:text-white group hover:bg-gray-50">
